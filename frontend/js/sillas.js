...
function CargarSillas()   
{
    ...
    $.ajax(         //Ajax para traer los sillas de mi base de datos y ponerlos en la pagina
    {    
        "url": URL_BASE + "sillas",
        "type": "GET",  //para obtener los sillas ya cargados
        "dataType": "json",
        "success": function(r)
        {
            $("table tbody").empty();             //vacío mi tabla antes de mostrar los sillas cargados
            r.forEach(function(item, index){    //recorro el array que devuelve el success que contiene la info de mis sillas, lo almaceno en item
                console.log(item);
