...
function CargarMouses()   
{
    ...
    $.ajax(         //Ajax para traer los mouses de mi base de datos y ponerlos en la pagina
    {    
        "url": URL_BASE + "mouses",
        "type": "GET",  //para obtener los mouses ya cargados
        "dataType": "json",
        "success": function(r)
        {
            $("table tbody").empty();             //vacío mi tabla antes de mostrar los mouses cargados
            r.forEach(function(item, index){    //recorro el array que devuelve el success que contiene la info de mis mouses, lo almaceno en item
                console.log(item);
